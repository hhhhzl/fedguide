...
def main():
    ...
    parser.add_argument("--config", type=str, default="configs/bandit2d/fedavg.yaml",
                        help="Path to YAML config (bandit2d FedKL-style; lambdas 0 => FedAvg)")
...
# Example: FedAvg with default bandit2d config
#   python scripts/envs/bandit2d/run_fedavg_bandit2d.py --config configs/bandit2d/fedavg.yaml --rounds 20
# Visualize (adjust --metrics_path to match your config's metrics_dir):
#   python scripts/envs/bandit2d/visualize_bandit2d.py --metrics_path ./metrics/bandit2d/fedavg/bandit2d_metrics.pkl --client_policies --client_policies_output plots/bandit2d/client_policies_fedavg.png --round_num 1
# Standalone env check:
