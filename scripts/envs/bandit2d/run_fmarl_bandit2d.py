"""
Entry point for FMARL federated training on Bandit2D.
...
def main():
    ...
    parser.add_argument("--config", type=str, default="configs/bandit2d/fedkl.yaml",  # FMARL uses similar config to FedKL
