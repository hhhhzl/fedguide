"""
Entry point for FedRL federated training on Bandit2D.
...
def main():
    ...
    parser.add_argument("--config", type=str, default="configs/bandit2d/fedkl.yaml",  # FedRL uses similar config
