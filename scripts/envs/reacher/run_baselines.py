"""Run all reacher baseline configs (federated baselines only).
...
``metrics/reacher_phase1/<algo>/seed_<i>/``.

Configs are loaded from ``configs/reacher/baseline/``:
    fedavg, fedkl, fedrep, fedmomentum, fmarl, fedrl_ddpg

Usage:
    python scripts/envs/reacher/run_baselines.py --seeds 0 --rounds 50
    python scripts/envs/reacher/run_baselines.py --only fedavg,fedkl
"""
...
JOBS = [
    ...
    ("fedavg",      "fedkl",        "configs/reacher/baseline/fedavg.yaml"),       # FedAvg = FedKL with λ=0
    ("fedkl",       "fedkl",        "configs/reacher/baseline/fedkl.yaml"),
    ("fedrep",      "fedrep",       "configs/reacher/baseline/fedrep.yaml"),
    ("fedmomentum", "fedmomentum",  "configs/reacher/baseline/fedmomentum.yaml"),
    ("fmarl",       "fmarl",        "configs/reacher/baseline/fmarl.yaml"),
    ("fedrl",       "fedrl",        "configs/reacher/baseline/fedrl_ddpg.yaml"),
    ("mfpo",        "mfpo",         "configs/reacher/baseline/mfpo.yaml"),
]
