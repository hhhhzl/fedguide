"""BC pretrain (warm-start) for D4RL Adroit FedGuide policies."""
...
from scripts.envs.adroit._pretrain import _collect_d4rl_dataset
...
def main():
    ...
    ap.add_argument("--d4rl_max_size", type=int, default=30000)
    ...
    for offset in range(args.num_clients):
        ...
        print(f"\n[BC] client {cid} | task={task}")
        s, a, _r, _s2, _d = _collect_d4rl_dataset(task, max_size=args.d4rl_max_size, seed=args.seed + cid)
