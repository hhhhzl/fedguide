...
class FedKLTrainer:
    ...
    def compute_local_kl(self, states: torch.Tensor) -> torch.Tensor:
        ...
        from fedguide.baselines.fedKL.agent import PolicyNetwork
        temp_policy = PolicyNetwork(self.agent.state_dim, self.agent.action_dim, hidden_dim=256)
        temp_policy.load_state_dict(self.local_policy_snapshot)
